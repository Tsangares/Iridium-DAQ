...
class Agilent4156(object):
    ...
    def configure_sampling_measurement(self, _mode=0, _filter=False, auto_time=True,
        ...
        self.inst.write(":PAGE:DISP:GRAP:Y2:NAME 'I2'")
        self.inst.write(":PAGE:DISP:GRAP:Y2:min -0.1")
        self.inst.write(":PAGE:DISP:GRAP:Y2:max 0.1")
        pass
    ...
    def read_trace_data(self, var="I1"):
        ...
        #print(_data)
        try:
            data = list(map(lambda x: float(x), _data.split(",")))
    ...
    def configure_channel(self, _chan=0, standby=False, _mode=4):
        _func = 3
